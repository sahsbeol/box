...
<div id="wrap" class="content_new">
    ...
    <div id="container" <%if(container != null && !"".equals(container)){%>class="<%=container%>"<%}%>>   
        ...
        <div class="content" id="content">
            ...
            <c:if test="${fn:contains(url,'/ht/biz/eventDetail')}">
				<aside id='skyscraper' class="quick_menu">
				<script type="text/javascript">skyScraper();</script>
				<div id="recentFacelist" style="padding-top:300px;"></div>
					<div class='btn_goTop'>
						<a href="javascript:$('html,body').stop().animate({scrollTop:0},0);"><img src="/images/biz/common/go_top.png" alt="페이지 상단으로 가기">TOP</a>
					</div>
				</aside>
            </c:if>
        </div>
