...
<head>
	...
	<script>
		function fnLoad(iRtn, sRtnMsg)
		{
			if(iRtn == '1'){
				parent.opener.document.location.href="/ht/help/createCounselForm";
				self.close();
			}else{
				alert(sRtnMsg);
				self.close();
...
<body onload="fnLoad('<%= iRtn %>', '<%= sRtnMsg %>')">

	<input type="hidden" name="enc_data" value="<%= sResponseData %>"><br>
	
	<%-- 
	<input type="hidden" value="<%= iRtn %>"><br>
	<input type="hidden" value="<%= sRtnMsg %>"><br>
	<input type="hidden" value="<%= sVNumber %>"><br>
	<input type="hidden" value="<%= sName %>"><br>
	<input type="hidden" value="<%= sAgeCode %>"><br>
	<input type="hidden" value="<%= sGenderCode %>"><br>
	<input type="hidden" value="<%= sBirthDate %>"><br>
	<input type="hidden" value="<%= sNationalInfo %>"><br>
	<input type="hidden" value="<%= sCPRequestNum %>"><br>
	<input type="hidden" value="<%= sDupInfo %>"><br>
	<input type="hidden" value="<%= sCoInfo1 %>"><br>
	<input type="hidden" value="<%= sCIUpdate %>"><br>
	<input type="hidden" value="<%= sAuthInfo %>"><br>
	 --%>
