...
jQuery(function($) {
    $("body").append("<div id=\"loadingBar\" style=\"position:absolute; z-index:1500; display:none\"><img src=\"https://simage.kyobobook.co.kr/newimages/giftshop_new/common/images/common/ajax-uploader.gif\" alt=\"loadingBar\"/></div>");
