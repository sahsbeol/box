    ...
    $.ajax({
        ...
        success : function(result, textStatus, XMLHttpRequest){
            if(result.errorMessages.length == 0){
                location.href = "/ht/mypage/myListDvdAddEnd?folderSeq="+folderSeq;
            }else{
...
function addFolderCreate(){
    ...
    $.ajax({
        async : true, 
        url : "/ht/mypage/myListDvdAddByFolder",
        dataType : "json", 
        type : "post", 
        data : {
        ...
        success : function(result, textStatus, XMLHttpRequest){
            if(result.errorMessages.length == 0){
                location.href = "/ht/mypage/myListDvdAddEnd";
            }else{
                alert(result.errorMessages[0]);
            }
        }, 
...
function goListView(myListFolderSeq){
    opener.location.href = "/ht/mypage/myListDvdList?myListFolderSeq="+myListFolderSeq;
    window.close();
}
</script>
</head>
...
<div style="width:480px;">
    ...
    <div class="pop_cont" style="height:350px;overflow-y:scroll;">
        ...
        <table class="table02 mgt15">
            ...
            <thead>
                <tr>
                    <th colspan="4">담은 BLU-RAY/DVD 폴더명</th>
                </tr>
            </thead>
            <tbody>
