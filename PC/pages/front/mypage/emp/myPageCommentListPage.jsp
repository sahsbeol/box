...
<div class="sub_contents">
    ...
    <h3 class="page_title mgt0"><img src="http://image.kyobobook.co.kr/newimages/giftshop_new/common/images/mypage/txt_01.png" alt="내 상품평 관리" /></h3>
    <ul class="list_type02">
        <li>등록하신 상품평을 수정 및 삭제할 수 있습니다.</li>
    ...
    <!-- paging -->
    <div class="paging">
        <ui:pagination url="/ht/mypage/commentList" name="pageHolder"  />
    </div>
    <!-- //paging -->
