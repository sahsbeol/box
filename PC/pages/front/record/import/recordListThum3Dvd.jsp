                        ...
                        <ul>
                            <c:forEach items="${list}" var="l" varStatus="s">
	                            <li>
	                                ...
	                                <p class="album_pic"><a href="/ht/record/detail/${l.sellPrdtBcode}" class="album_pic"><ui:image rcrdCd="${l.rcrdCd}" prdtGbn="${l.sellPrdtGbn}" width="147" alt="${l.rcrdName}" rcrdImgType="large" ratingCode="${l.ratingCode}" /></a></p>
