<%
    ...
    else
    {
        ...
        lpinfo.setDomain(".hottracks.co.kr");
        lpinfo.setPath("/");
/*
...
*/
        ...
        // liveCorn check cookie
        Cookie lnk = new Cookie("LinkCookieKey", "LP");
        lnk.setDomain(".hottracks.co.kr");
        lnk.setPath("/");
/*        
        if (Integer.parseInt(rd) != 0)
        {
            lnk.setMaxAge(60 * 60 * 24 * Integer.parseInt(rd));
        }
*/
        response.addCookie(lnk);
    }
%>
<html>
<head>
