...
<div id="contents_area">
            ...
            <tbody>
                ...
                <c:forEach items="${list}" var="l" varStatus="st">
                    <tr>
                        ...
                        <td class="Tleft"><a href="/company/recruit/noticeView?boardseq=${l.boardseq}" <c:if test="${nowDate == l.registerdate}">class=" new"</c:if>>${l.title}</a></td>
    ...
    <!-- paging -->
    <div class="paging">
        <ui:pagination name="pageHolder" url="/company/recruit/notice" parameters="sKind,sWord"/>
    </div>
    <!-- //paging -->
    <!-- search -->
