...
<div id="contents_area">
    ...
    <div class="table_view">
        <table summary="행사안내 상세보기 테이블입니다. 행사명, 진행영업점, 행사기간으로 구성 된 행사안내 상세보기" cellpadding="0" cellspacing="0">
            ...
            <colgroup>
                ...
                <tbody>
                    ...
                    <c:if test="${not empty bbsfile && not empty bbsfile.filename }">
                        <tr>
            ...
            <table summary="리스트 테이블입니다. 번호, 행사명, 행사기간 항목이 있습니다.">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="Tleft"><a href="/company/story/eventView?boardseq=${l.boardseq}" list="list">${l.title }</a><c:if test="${l.newYn eq 'Y'}"><img src="http://image.hottracks.co.kr/info/common/icon_new.png" alt="New" /></c:if></td>
                        <td>
        ...
        <!-- paging -->
        <div class="paging">
            <ui:pagination name="pageHolder" url="/company/story/eventView" parameters="srchGbn,srchKeyword,boardseq"/>
        </div>
        <!-- //paging -->
        <!-- search -->
