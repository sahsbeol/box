...
.timetable .table tbody td .checked01 { background:url('http://image.kyobobook.co.kr/newimages/giftshop_new/common/images/event/66359/check_icon.png') no-repeat 50% 50%; }
.timetable .table tbody td .checked02 { background:url('http://image.kyobobook.co.kr/newimages/giftshop_new/common/images/event/66359/check_icon.png') no-repeat 50% 50%; }
