...
<%@ page import="kr.co.hottracks.site.utils.EncryptUtils" %>
...
<%
    ...
    String LGD_MERTKEY          = "6eb2afe9484ff188335c7adb858acc1e";                   //상점MertKey(mertkey는 상점관리자 -> 계약정보 -> 상점정보관리에서 확인하실수 있습니다)
     ...
     */
    String LGD_CASNOTEURL       = "https://www.hottracks.co.kr/pages/front/test/cas_noteurl.jsp";

    /*
     * LGD_RETURNURL 을 설정하여 주시기 바랍니다. 반드시 현재 페이지와 동일한 프로트콜 및  호스트이어야 합니다. 아래 부분을 반드시 수정하십시요.
     */
    String LGD_RETURNURL        = "https://www.hottracks.co.kr/pages/front/test/returnurl.jsp";// FOR MANUAL
    ...
    String LGD_HASHDATA = EncryptUtils.md5(sb.toString());
...
<script language="javascript" src="https://xpay.uplus.co.kr:9443/xpay/js/xpay_crossplatform.js" type="text/javascript"></script>
