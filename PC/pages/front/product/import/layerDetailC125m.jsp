...
<table class="table04 mgt80">
    ...
    <tbody>
        ...
        <tr>
            <th scope="row">생산자 및 소재지<br/>제조사</th>
        ...
        <tr>
            ...
            <td>${prdtNotiInfo.dtInfo}</td>
            <th scope="row">수입여부</th>
            <td>${prdtNotiInfo.impYn eq 'Y'?'수입':'국산'}${prdtNotiInfo.impYn eq 'Y'?' : 식품위생법에 따른 수입신고를 필함':''}</td>
        </tr>
        <tr>
            <th scope="row">주원료</th>
            <td colspan="3">
        ...
        <c:if test="${prdtNotiInfo.caution ne '해당없음'}">
            <tr>
                <th scope="row">섭취량/섭취방법 및<br/> 섭취시주의사항</th>
        ...
        <c:if test="${prdtNotiInfo.etc3 ne '해당없음'}">
            <tr>
                ...
                <td colspan="3">${prdtNotiInfo.etc3}</td>
            </tr>
        </c:if>
        <tr>
