...
<div class="music_wrap">
    ...
    <section class="musicmain">
        ...
        <div class="sns f_right" style="margin:0 18px 20px 0;">
            <a href="#" onclick="goTwitter('${special.title}', 'www.hottracks.co.kr/ht/idol/specialDetail?cntid=${special.cntid}');return false;"><img src="http://image.kyobobook.co.kr/newimages/giftshop_new/common/images/renewal/common/ico_sns_twitter.png" alt="twitter"></a>
            <a href="#" onclick="goFaceBook('${special.title}', 'www.hottracks.co.kr/ht/idol/specialDetail?cntid=${special.cntid}');return false;"><img src="http://image.kyobobook.co.kr/newimages/giftshop_new/common/images/renewal/common/ico_sns_facebook.png" alt="facebook"></a>
            <a href="#" onclick="goPinterest('${special.title}', 'www.hottracks.co.kr/ht/idol/specialDetail?cntid=${special.cntid}');return false;"><img src="http://image.kyobobook.co.kr/newimages/giftshop_new/common/images/renewal/common/ico_sns_pinterest.png" alt="pinterest" style="width:28px;height:28px;" nopin="true"></a>
        </div>
            ...
            <span class="chart_logo">
                ...
                <div id="defaultBannerArea" style="display: none;">
	                <a href="https://idol-chart.com/" target="_blank" >
	                    <span id="logo_img" class="PC_MUSICMAGAZINE_2"></span>
	                </a>
                </div>
                <div id="evnetBannerArea" style="display: none;">
	                <a href="https://www.idol-chart.com/event/?mode=view&no=34" target="_blank" >
	                    <span id="logo_img_event1" class="PC_MUSICMAGAZINE_2"></span>
	                </a>
                </div>
            <span id="gotoNews"><a href="/ht/idol/special">목록</a></span>
            </span>
