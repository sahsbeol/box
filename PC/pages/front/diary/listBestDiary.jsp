...
<div class="welcom_top">
    <h2 class="title"><img src="http://image.kyobobook.co.kr/newimages/giftshop_new/common/images/diary/2018/best-icon.jpg" alt="DIARY BEST 20" /></h2>
    <span class="date"><ui:mask pattern="####.##.##">${c.todayStr}</ui:mask></span>
</div>
<div class="welcom_conts" style="background: none;">
