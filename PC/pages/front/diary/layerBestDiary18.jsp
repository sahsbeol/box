...
<div class="layer_conts">
    <div class="prod_list_normal best">
        <ul><!-- 1 -->
            <c:forEach items="${list}"  var="l" varStatus="s1" begin="0" end="2">
                <li>
                    <div class="rank">
                        <strong>${l.dispOrder}</strong>
                    </div>
                    <span class="img">
                        <a href="/ht/product/detail?barcode=${l.sellPrdtBcode}" title="${l.prdtName}"><ui:image src="${l.productImageUrl}" size="400" server="product" alt="${l.prdtName}"/></a>
                        <div class="hide_util">
            ...
            <c:forEach items="${list}" varStatus="s1" begin="3" step="4" end="19">
