					...
					<div class="swiper-container">
						<div class="swiper-wrapper">
							...
							<div class="swiper-slide">
								...
								<a href="#none">
									<div class="cont">
										<p class="brand">wearinggeul</p>
										<p class="tit">[페이스인페이스]실키포어 선스틱 실키포어 선스틱</p>
										<p class="price font_t">
											<span class="percent">20%</span>
											<span>999,999</span>
											<span class="discount">999,999</span>
										</p>
										<div class="info">
											<span class="reply">999+</span>
					        	...
					        	<div class="cont">	        	
									...
									<div class="badge">
										<c:choose>
						    				...
						    				<c:otherwise>
												<c:choose>
													<c:when test="${l.prdtStatCode ne 'C0312'}"><span class="badge03">품절</span></c:when>
													<c:otherwise>
														<c:if test="${fn:substring(l.prdtIcon,0,1) eq '1'}"><span class="badge01">쿠폰</span></c:if>
