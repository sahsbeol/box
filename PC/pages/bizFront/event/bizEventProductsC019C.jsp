                            ...
                            <a href="/p/${l.sellPrdtBcode}">
                                ...
                                <em class="price">
                                    ...
                                    <c:if test="${l.prdtSellPrice ne l.lastCpnPrice}">
                                        ...
                                        <c:if test="${l.prdtStatCode eq 'C0312'}"><span class="pc"><fmt:parseNumber var="percent" integerOnly="true" value="${hfn:rate(l.prdtSellPrice,l.lastCpnPrice)}"/>${percent}%</span></c:if>
                                    </c:if>
                                </em>
                            </a>
                        </li>
