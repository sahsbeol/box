...
<head>
<title>
<c:if test="${c.searchAudioLpBox eq 'audio'}">AUDIO PHILE</c:if>
<c:if test="${c.searchAudioLpBox eq 'lp'}">LP SHOP</c:if>
<c:if test="${c.searchAudioLpBox eq 'box'}">BOX SET</c:if>
| CD - HOTTRACKS
</title>
...
<div class="cate03">
    <h2 class="tit">
        <c:if test="${c.searchAudioLpBox eq 'audio'}"><img src="${imageServer}/images/renewal/shop/cdsub_tit_audio.gif" alt="AUDIO PHILE" /></c:if>
        <c:if test="${c.searchAudioLpBox eq 'lp'}"><img src="${imageServer}/images/renewal/shop/cdsub_tit_lp.gif" alt="LP SHOP" /></c:if> 
        <c:if test="${c.searchAudioLpBox eq 'box'}"><img src="${imageServer}/images/renewal/shop/cdsub_tit_box.gif" alt="BOX SET" /></c:if>
    </h2>
    <ul>
        <c:if test="${c.searchAudioLpBox eq 'audio'}">
            <li><a <c:if test="${empty c.searchAudioLpBoxCate}">class="on"</c:if> href="?<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">전체</a></li>
            <li><a <c:if test="${c.searchAudioLpBoxCate eq 'classic'}">class="on"</c:if> href="?searchAudioLpBoxCate=classic&<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">클래식</a></li>
            <li><a <c:if test="${c.searchAudioLpBoxCate eq 'pop'}">class="on"</c:if> href="?searchAudioLpBoxCate=pop&<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">팝</a></li> 
            <li><a <c:if test="${c.searchAudioLpBoxCate eq 'jazz'}">class="on"</c:if> href="?searchAudioLpBoxCate=jazz&<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">재즈</a></li> 
        </c:if>
        <c:if test="${c.searchAudioLpBox eq 'lp'}">
            <li><a <c:if test="${empty c.searchAudioLpBoxCate}">class="on"</c:if> href="?<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">전체</a></li>
            <li><a <c:if test="${c.searchAudioLpBoxCate eq 'song'}">class="on"</c:if> href="?searchAudioLpBoxCate=song&<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">가요</a></li>
            <li><a <c:if test="${c.searchAudioLpBoxCate eq 'classic'}">class="on"</c:if> href="?searchAudioLpBoxCate=classic&<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">클래식</a></li>
            <li><a <c:if test="${c.searchAudioLpBoxCate eq 'pop'}">class="on"</c:if> href="?searchAudioLpBoxCate=pop&<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">팝</a></li> 
            <li><a <c:if test="${c.searchAudioLpBoxCate eq 'rock'}">class="on"</c:if> href="?searchAudioLpBoxCate=rock&<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">락</a></li>
            <li><a <c:if test="${c.searchAudioLpBoxCate eq 'jazz'}">class="on"</c:if> href="?searchAudioLpBoxCate=jazz&<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">재즈</a></li>
            <li><a <c:if test="${c.searchAudioLpBoxCate eq 'worldmusic'}">class="on"</c:if> href="?searchAudioLpBoxCate=worldmusic&<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">월드뮤직</a></li>
            <li><a <c:if test="${c.searchAudioLpBoxCate eq 'ost'}">class="on"</c:if> href="?searchAudioLpBoxCate=ost&<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">OST</a></li>
        </c:if> 
        <c:if test="${c.searchAudioLpBox eq 'box'}">
            <li><a <c:if test="${empty c.searchAudioLpBoxCate}">class="on"</c:if> href="?<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">전체</a></li>
            <li><a <c:if test="${c.searchAudioLpBoxCate eq 'song'}">class="on"</c:if> href="?searchAudioLpBoxCate=song&<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">가요</a></li>
            <li><a <c:if test="${c.searchAudioLpBoxCate eq 'classic'}">class="on"</c:if> href="?searchAudioLpBoxCate=classic&<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">클래식</a></li>
            <li><a <c:if test="${c.searchAudioLpBoxCate eq 'pop'}">class="on"</c:if> href="?searchAudioLpBoxCate=pop&<ui:param skip="page,order,listSize,searchAudioLpBoxCate" />">팝</a></li> 
...
<div class="list_section">
    ...
    <!-- paging -->
    <div class="paging"><ui:pagination name="pageHolder" url="?" parameters="order,impYn,saleYn,listSize,searchAudioLpBoxCate"/></div>
    <!-- //paging -->
    ...
    <!-- paging -->
    <div class="paging mgt40"><ui:pagination name="pageHolder" url="?" parameters="order,impYn,saleYn,listSize,searchAudioLpBoxCate"/></div>
    <!-- //paging -->
</div>
</body>
</html>