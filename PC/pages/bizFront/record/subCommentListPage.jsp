...
jQuery(function($) {
    ...
    function deleteWithAjax(e){
        ...
        $.ajax({
            ...
            ,dataType: "json"
            ,data:{seq:e.data.seq, rcrdCd:"${qnACriteia.rcrdCd}"}
