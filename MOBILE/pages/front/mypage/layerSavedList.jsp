...
<ul class="br_list mb30">
    <c:if test="${empty list && c.page eq 1}">
        <li class="line bg_eeeeee"><strong>고객님께서 ${c.srchGbn eq '0'?'적립':'사용'}하신 마일리지 내역이 존재하지 않습니다.</strong></li>
    </c:if>
    <c:forEach items="${list}" var="l" varStatus="st">
        <li class="line bg_eeeeee">
            <strong><fmt:formatDate value="${l.modDtm}" pattern="yyyy.MM.dd"/></strong>
        </li>
        <li>
