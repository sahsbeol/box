...
<div class="customer mt17">
    ...
    <p class="noti_re" style="display: inline-block; width: 100%; max-width: 564px; margin: 20px 0;">
        <img src="http://image.kyobobook.co.kr/newimages/giftshop_new/common/images/mypage/20_targetreview.jpg" style="width:100%;"/>
    </p>
