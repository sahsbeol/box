...
<div id="evnetBannerArea" style="">
 <!--    <a href="/m/biz/eventDetail?eventId=67359">
    ...
    <a href="/m/biz/eventDetail?eventId=67701">
        <img src="http://image.kyobobook.co.kr/newimages/giftshop_new/event/banner/20200429/2020042967701750.jpg" alt="ban_event" style="width: 100%;">
    </a> -->
	...
	<c:forEach items="${cartBnrList}" var="l" varStatus="st">
        <a href="${l.bnrLinkUrl}" >
