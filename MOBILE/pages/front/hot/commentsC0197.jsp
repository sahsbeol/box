...
<ul class="commnt_list">
    <c:forEach items="${comments}" var="comment" varStatus="status">
        <li>
            ...
            <p><ui:image src="${comment.emtcUrl}"/></p>
            <p>
                <c:choose>
            ...
            <span class="btn_del">
                <c:if test="${comment.userNum == loginUser.userNum}">
                    <a href="#" onclick="deleteComment('${comment.eventCmntSeq}');return false;"><img src="${imageServer}/images/mobile/common/btn_del01.gif"/></a>
                </c:if></td>
            </span>
        </li>
    </c:forEach>
