...
<ul class="txt_list">
    ...
    <li><strong>제조일자 : </strong>${prdtNotiInfo.dtInfo}</li>
    <li><strong>제품 소재 : </strong>${fn:trim(prdtNotiInfo.material)}</li>
    <li><strong>취급시 주의사항 : </strong>${fn:trim(prdtNotiInfo.caution)}</li>
    <li><strong>품질보증기준 : </strong>${fn:trim(prdtNotiInfo.wrntPolicy)}</li>
