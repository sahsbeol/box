...
<ul class="txt_list">
    ...
    <li><strong>제품의 사용목적 및 사용방법: </strong>${prdtNotiInfo.useMethd}</li>
    <li><strong>허가신고 및 사전심의 번호: </strong>${prdtNotiInfo.etc1}</li>
