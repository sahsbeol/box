...
#ly_content .login_wrap h3 { color:#3d3d3d;margin-bottom:10px;background:url('http://image.kyobobook.co.kr/newimages/giftshop_new/common/images/mobile/common/ico_hot.jpg') 1px 0 no-repeat;background-size:15px;padding-left:20px; }
#ly_content .login_wrap .tit { text-align:center;font-weight:bold;margin-bottom:10px; }
...
#ly_content .btn_login { float:none !important;display: block;clear:both;text-align:center;height: 37px;line-height: 37px;padding: 0 23px;border: 1px solid #f05f07;border-radius: 3px;background: #ff6600;font-size: 14px;color: #fff; }
...
<div id="ly_content">
    ...
    <div class="login_wrap roundbox mt20">
        <form name="loginFrm" action="/m/nouserLogin" method="get">
            <input type="hidden" name="returnUrl" value="${returnUrl}"/>
            <fieldset>
                <h3>비회원로그인</h3>
                <ul>
                    <li class="input_wrap"><input type="text" name="orderNum" class="log_id" title="주문번호 입력" placeholder="주문번호" /></li>
                    <li class="input_wrap"><input type="password" name="passwd" class="log_pw" title="주문 비밀번호 입력" placeholder="주문 비밀번호" /></li>
                </ul>
                ${errorMessagesForNoUser}
