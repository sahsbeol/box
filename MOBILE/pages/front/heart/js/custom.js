...
(function($, window, document, undefined) {
    ...
    $(document).ready(function() {
        ...
        if ($('.history-list2').length) {
            $('.history-list2').owlCarousel({
                loop: true,
                nav: false,
                dots: true,
                items: 1,
        ...
        if ($('.fullpage-default').length) {
            var myFullpage = new fullpage('.fullpage-default', {
                ...
                anchors: ['slide01', 'slide02', 'slide03', 'slide04', 'slide05', 'slide06', 'slide07', 'slide08', 'slide09', 'slide10', 'slide11', 'slide12'],
                menu: '#nav',
                lazyLoad: true,
                navigation: true,
