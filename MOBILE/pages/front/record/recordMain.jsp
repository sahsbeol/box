...
function loadEvent(){
    ...
    $.ajax({
        type: "GET"
       ,url: "/m/hot/eventMore?orderBy=P&ctgrId=0003&page="+page
       ,dataType: "html"
...
<div id="cate-sub-menu">
    <div class="cate">
        <ul>
            ...
            <li><a href="/m/record/reserve/0003">예약음반</a></li>
            <li><a href="/m/record/best/0003">음반베스트</a></li>
            <c:forEach items="${childCategory}" var="l" varStatus="st" end="6">
                <li><a href="/m/record/category/${l.ctgrId}">${l.ctgrName}</a></li>
            </c:forEach>
        </ul>
        <ul class="hid_obj">
            <c:forEach items="${childCategory}" var="l" varStatus="st" begin="7">
                <li><a href="/m/record/category/${l.ctgrId}">${l.ctgrName}</a></li>
            </c:forEach>
        </ul>
    </div>
