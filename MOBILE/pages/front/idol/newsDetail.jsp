        ...
        <div class="news_detail">
            ...
            <div class="event_sub_info" style="height:10px;">
                <div class="sns" style="top:-42px;">
                    <a href="#" onclick="goTwitter('${fn:escapeXml(news.title)}', 'http://m.hottracks.co.kr/m/idol/newsDetail?cntid=${news.cntid}');return false;" class="ic_twitter">트위터</a>
                    <a href="#" onclick="goFaceBook('${fn:escapeXml(news.title)}', 'http://m.hottracks.co.kr/m/idol/newsDetail?cntid=${news.cntid}');return false;" class="ic_facebook">페이스북</a>
                    <a href="#" onclick="sendKakao('[핫트랙스] ${fn:escapeXml(news.title)}', 'http://m.hottracks.co.kr/m/idol/newsDetail?cntid=${news.cntid}');return false;"class="ic_kakaotalk">카카오톡</a>
                </div>
            </div>
            ...
            <span class="chart_logo">
                ...
                <span id="gotoNews"><a href="/m/idol/news">목록</a></span>
            </span>
            <!-- 연관상품 -->
            <div class="prod_box">
