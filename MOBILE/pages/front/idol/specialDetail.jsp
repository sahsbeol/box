...
<div class="music_wrap">
    ...
    <section class="musicmain">
        <div style="display: flex;height: 49.5px;">
            <p id="news"><a href="/m/idol/news">신곡뉴스</a></p>
            <p id="speical" class="on"><a href="/m/idol/special">아이돌매거진</a></p>
        </div>
        <div class="special_detail">
            ...
            <div class="event_sub_info" style="height:10px;">
                <div class="sns" style="top:-42px;">
                    <a href="#" onclick="goTwitter('${fn:escapeXml(special.title)}', 'http://m.hottracks.co.kr/m/idol/specialDetail?cntid=${special.cntid}');return false;" class="ic_twitter">트위터</a>
                    <a href="#" onclick="goFaceBook('${fn:escapeXml(special.title)}', 'http://m.hottracks.co.kr/m/idol/specialDetail?cntid=${special.cntid}');return false;" class="ic_facebook">페이스북</a>
                    <a href="#" onclick="sendKakao('[핫트랙스] ${fn:escapeXml(special.title)}', 'http://m.hottracks.co.kr/m/idol/specialDetail?cntid=${special.cntid}');return false;"class="ic_kakaotalk">카카오톡</a>
                </div>
            </div>
