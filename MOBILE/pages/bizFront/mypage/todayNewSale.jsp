		...
		,loadData : function(){	/*	페이징		*/
		    ...
		    if($("[name=eofObj]").val() == "0"){
		        ...
		        $.ajax({
		            type: "GET"
		           ,async:false
		           ,url: "/m/biz/mypage/todayNewSale?lazy=Y&pagingLoad=true&productOrderBy="+ $('#orderBySelect').val() +"&ctgrId="+ $('#selectOption').val() +"&page="+ obj.page
		           ,dataType: "html"
...
<div id="content">
	<div class="curtain_zone">
		<div class="inner">
			<p><span>오늘부터 할인</span>이 되고 있는 상품이에요!</p>
