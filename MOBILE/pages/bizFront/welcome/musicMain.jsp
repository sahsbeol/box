...
$(document).ready(function() {
    ...
    $(".layer_banner_top").bind("touchmove", function(e) {
	  ...
	  //메인탭스와이퍼 재설정
    /* recobelTemplet(true) */
    $('.page-menu.menu-music').addClass('active');
});
/* 
2020년 06월 08일 박지현과장님 개선건 
		...
		<div class='record_wrap'>
                ...
                <div class="swiper-container bnr-container">
                    ...
                    <div class='pagination_wrap font_t'>
                    	<a href="javascript:" class='paging_link_r'>
							...
							<div class="plus_inner_r MB_MAIN_MUSIC_1_1">
				...
				<div class="record_booking">
					...
					<div class="swiper-container album-container">
				      ...
				      <c:forEach items="${list}" var="l"  begin="0" end="19" >
				        <div class="swiper-slide MB_MAIN_MUSIC_2_4">
				...
				<div class="record_booking">
					...
					<div class="swiper-container recent-container">
				      ...
				      <div id="prod0${s1.index}"  class="swiper-wrapper">
				      <c:forEach items="${list}" var="l" begin="0" end="19">
				        <div class="swiper-slide MB_MAIN_MUSIC_3_4">
							<div class='album_wrapper'>
								<div class='album_inner'>
				...
				<div class='recomm_wrap'>
					...
					<h3>좋아할 최신앨범</h3>
					<c:forEach items="${listRecobell}" var="l" varStatus="st" begin="0" end="0" >
					<div class='album_recomm MB_MAIN_MUSIC_7' <c:if test="${st.index ne '0'}">style="display:none;"</c:if>>
						<span>
						...
						<a href="javascript:;" onclick="location.href='/p/${l.sellPrdtBcode}?foo=bar&rccode=mo_main2';return false;"></a>
					</div>
					</c:forEach>
					<ul class='list_recomm' style="display: table;">
					<c:forEach items="${listRecobell}" var="l" begin="1" end="3">
						<li class="MB_MAIN_MUSIC_7">
							<span>
								<c:if test="${l.sellPrdtGbn eq 'P' || l.sellPrdtGbn eq 'G'}">
									<ui:image src="${l.productImageUrl}" server="product" alt="${fn:escapeXml(l.prdtName)}"/>
								</c:if>
					...
					<%-- 2020년 06월 08일 박지현과장님 개선건 
					<div class='seemore_wrap MB_MAIN_MUSIC_7_2'>
						...
						<a href="javascript:" class="btn_change" id="pdBtn" onclick="recobelTemplet(false);"></a>
					</div> 
					--%>
				</div>
				<!-- //맞춤추천 -->
				...
				<div class='magazine_wrap'>
					...
					<a href="/m/biz/idol/news" class='btn_genre'><img src="../../images/biz/common/arrow_wh_L.png" alt="다음 장르"></a>
	                <%-- 2020년 06월 08일 박지현과장님 개선건  
	                <c:forEach items="${idolNews}" var="l"  begin="0" end="0" varStatus="st">
					<div class="music_mag MB_MAIN_MUSIC_8_1">
						<span><img src="${l.image }" alt=""></span>
						<h3>${l.title }</h3>
						<em class='font_ns'>${l.pubdt}</em>
						<a href="/m/biz/idol/newsDetail?cntid=${l.cntid }"></a>
					</div>
					</c:forEach> 
					--%>
					<div class="swiper-container mag-container">
					    ...
					    <c:forEach items="${idolNews}" var="l" varStatus="st" begin="0" end="9">
					      <div class="swiper-slide MB_MAIN_MUSIC_8_2">
						...
						<ul>
							<c:forEach items="${mainRollBnrList}" var="l" varStatus="st">
			                    ...
			                    <li class="type01">
									...
									<c:if test="${l.flagCd eq 'E'}">
										<div class="pagination_wrap" style="display:block;">
			                                <div class="bnr_type type_ad">
			                                    <p class="type_en" style="display:block;">응모</p>
			                                </div>
			                            </div>
									</c:if>
									<c:if test="${l.flagCd eq 'A'}">
										<div class="pagination_wrap" style="display:block;">
			                                <div class="bnr_type type_ad">
			                                    <p class="type_en" style="display:block;">광고</p>
			                                </div>
			                            </div>
									</c:if>
								</li>
