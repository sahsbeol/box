...
<head>
<title>[NEW ME 핫트랙스] ${special.title}</title>
...
<meta property="og:title" content="${fn:escapeXml(special.title)}">
<meta property="og:type" content="website"/>
<meta property="og:url" content="http://m.hottracks.co.kr/m/idol/specialDetail?cntid=${special.cntid}"/>
...
<div class="music_wrap">
    ...
    <section class="musicmain">
        <div style="display: flex;height: 49.5px;">
            <p id="news"><a href="/m/biz/idol/news">신곡뉴스</a></p>
            <p id="speical" class="on"><a href="/m/biz/idol/special">아이돌매거진</a></p>
        </div>
        <div class="special_detail">
            <span class="title">${special.title }</span>
            <span class="date">${special.pubdt }</span>
            <!-- SNS 기능 추가  -->
            ...
            <div class="event_sub_info" style="height:10px;">
                <div class="sns" style="top:-42px;">
                    <a href="#" onclick="goTwitter('${fn:escapeXml(special.title)}', 'http://m.hottracks.co.kr/m/biz/idol/specialDetail?cntid=${special.cntid}');return false;" class="ic_twitter">트위터</a>
                    <a href="#" onclick="goFaceBook('${fn:escapeXml(special.title)}', 'http://m.hottracks.co.kr/m/biz/idol/specialDetail?cntid=${special.cntid}');return false;" class="ic_facebook">페이스북</a>
                    <a href="#" onclick="sendKakao('[핫트랙스] ${fn:escapeXml(special.title)}', 'http://m.hottracks.co.kr/m/biz/idol/specialDetail?cntid=${special.cntid}');return false;"class="ic_kakaotalk">카카오톡</a>
                </div>
            </div>
            <span class="detail">${special.description }</span>
            ...
            <span class="chart_logo">
                ...
                <div id="defaultBannerArea" style="display: none;">
	                <a href="https://idol-chart.com/" id="logo_img" onClick="javascript:openIdolChart();">
	                    ...
	                    <img id="logo_bg" class="M_MUSICMAGAZINE_2" src="http://image.kyobobook.co.kr/newimages/giftshop_new/common/images/idol/btn-bg.png"/>
	                </a>
				</div>
				<div id="evnetBannerArea" style="display: none;">
	                <a href="https://m.idol-chart.com/event/?mode=view&no=34" id="logo_img" onClick="javascript:openIdolChart();">
	                    <img id="logo_bg" class="M_MUSICMAGAZINE_2" src="http://image.kyobobook.co.kr/newimages/giftshop_new/common/images/idol/btn-outlink-event1_m.jpg"/>
	                </a>
				</div>
                <span id="gotoNews"><a href="/m/idol/special">목록</a></span>
            </span>
            </span>
            <!-- 연관상품 -->
            <div class="prod_box">
